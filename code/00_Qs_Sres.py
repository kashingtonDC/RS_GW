...
def streamflow():
	'''
	wrapper to call get_streamflow for all hucs in our area of interest
	'''
...
def dayflow():
	'''
	Query CA DWR website to get monthly outflow to the sf bay delta
	'''

	print("**** Begin Fetching Outflow to SF bay (DWR Dayflow) ****")

	dayflow_path = '../data/dayflow-results-1997-2020.csv'
	dayflow_url = 'https://data.cnra.ca.gov/dataset/06ee2016-b138-47d7-9e85-f46fae674536/resource/21c377fe-53b8-4bd6-9e1f-2025221be095/download/dayflow-results-1997-2020.csv'
...
def res_storage(shp, outfn):
	...
	for i in tqdm(within_gdf.ID):
		# print("processing " + i )
		url = "https://cdec.water.ca.gov/dynamicapp/req/CSVDataServlet?Stations={}&SensorNums=15&dur_code=M&Start=1997-01-01&End=2021-01-01".format(i)
