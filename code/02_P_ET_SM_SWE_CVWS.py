...
# Precip
gpm = rs.calc_monthly_sum(data['gpm'], startdate, enddate, area_cvw)
...
psn = rs.calc_monthly_sum(data['persiann'], startdate, enddate, area_cvw)
...
# SMAP
smap_ssm = rs.calc_monthly_mean(data['smap_ssm'], '2015-04-01', enddate, area_cvw)
smap_susm = rs.calc_monthly_mean(data['smap_susm'],'2015-04-01', enddate, area_cvw)
smap_smp = rs.calc_monthly_mean(data['smap_smp'],'2015-04-01', enddate, area_cvw)
